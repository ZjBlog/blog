<template>
  <div class="hello"  style="background: #efefef;">
      <el-row class="header">
        <el-col :span="6">
          <div>
            <img src="../../static/images/logo.png" width="100px;" height="100%" style="margin-left:50%"/>
          </div>
        </el-col>
        <el-col :span="16">
          <el-menu
